...
data1 = load('HITRAN_340_data.dat');  % Replace 'file1.dat' with your first filename
x1 = data1(:,1);  % First column as x
y1 = data1(:,2);  % Second column as y

% Read data from second .dat file
data2 = load('theoretical_CS_340_GFE_CALIBRATED.dat');  % Replace 'file2.dat' with your second filename
