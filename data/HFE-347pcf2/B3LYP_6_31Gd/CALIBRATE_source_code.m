...
%input data
i=2; %Enter temperature index value
which_energy='ent'; %enter 'ent' or 'GFE' (case sensitive)
x_orca=[648.6,856.7,991.0,1157.6,1201.8,1312.4,1471.9];          %wavenumber from orca calculation, replace with wanted values
y_orca=[2.0933E-19,4.38446E-19,3.79361E-19,2.22709E-18,4.28925E-18,1.40452E-18];
x_hitr=[659.569,848.047,970.716,1144.13,1185.56,1288.97,1435.66];          %wavenumber from hitran database, replace with wanted values
y_hitr=[2.141E-19,3.17E-19,2.786E-19,3.052E-18,3.826E-18,1.108E-18,2.09E-19];
