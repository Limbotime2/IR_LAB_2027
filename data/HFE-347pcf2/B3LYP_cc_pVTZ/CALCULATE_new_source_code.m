...
y_n="no"; %is HITRAN data available?
...
for i=1:length(T)
    SPEC=THEORETICAL_CROSS_SECTION(num_conf,T(i),'ent',pop_ent(:,i),FWHM,'lorentzian',ir_data,1,0);
    SPEC=THEORETICAL_CROSS_SECTION(num_conf,T(i),'GFE',pop_GFE(:,i),FWHM,'lorentzian',ir_data,1,0);
end

save('intermediary_variables.mat','num_conf','T',"pop_ent","pop_GFE","ir_data","FWHM")
